...
export namespace Prisma {
  ...
  */
  ...
  export type mOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"sno" | "title" | "description" | "status", ExtArgs["result"]["m"]>
  ...
  type mCountArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    Omit<mFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
  ...
  export interface mDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `sno`
     * const mWithSnoOnly = await prisma.m.findMany({ select: { sno: true } })
     * 
     */
  ...
  interface mFieldRefs {
    readonly sno: FieldRef<"m", 'Int'>
    readonly title: FieldRef<"m", 'String'>
    readonly description: FieldRef<"m", 'String'>
    readonly status: FieldRef<"m", 'String'>
  }
  ...
  export type mFindUniqueArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    /**
     * Omit specific fields from the m
     */
    omit?: mOmit<ExtArgs> | null
    /**
  ...
  export const mOrderByRelevanceFieldEnum: {
    title: 'title',
    description: 'description',
    status: 'status'
  };

  export type mOrderByRelevanceFieldEnum = (typeof mOrderByRelevanceFieldEnum)[keyof typeof mOrderByRelevanceFieldEnum]
  ...
  export type mWhereInput = {
    ...
    sno?: IntFilter<"m"> | number
    title?: StringFilter<"m"> | string
    description?: StringFilter<"m"> | string
    status?: StringFilter<"m"> | string
  }
  ...
  export type mOrderByWithRelationInput = {
    ...
    status?: SortOrder
    _relevance?: mOrderByRelevanceInput
  }
  ...
  export type mScalarWhereWithAggregatesInput = {
    ...
    sno?: IntWithAggregatesFilter<"m"> | number
    title?: StringWithAggregatesFilter<"m"> | string
    description?: StringWithAggregatesFilter<"m"> | string
    status?: StringWithAggregatesFilter<"m"> | string
  }
  ...
  export type mOrderByRelevanceInput = {
    fields: mOrderByRelevanceFieldEnum | mOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
